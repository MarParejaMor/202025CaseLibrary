    ...
    <header class="bg-dark-card text-white py-3 shadow-sm">
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav>
          ...
          <a href="../php/ver_eventos.php" class="text-white me-3 text-decoration-none">Eventos</a>
          <a href="Perfil_privado.php" class="text-white me-3 text-decoration-none">Perfil</a>
